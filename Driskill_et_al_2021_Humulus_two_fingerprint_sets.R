...
getwd()
setwd("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Hops_08.19.2021/source_code_documents")
...
#Initiating "packrat
packrat::init("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Hops_08.19.2021/source_code_documents")
...
library(genepop)
library(factoextra)
library(LEA, lib.loc="~/Desktop/USDA/Hops/Final_scientific_documents/Hops_08.19.2021/source_code_documents/packrat/lib/x86_64-apple-darwin17.0/4.0.2")
library(grid)
library(data.table)
library(cluster)
library(NbClust)
...
mydat_table1 = read.table("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/Bi_parental_pop1.txt", header = TRUE, stringsAsFactors = FALSE)
mydat_table2 = read.table("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/Bi_parental_pop2.txt", header = TRUE, stringsAsFactors = FALSE)
...
#writng file
ggsave(file="/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Results/Bi-ParentalPops.pdf", plot = biparental_dendros, device = "pdf")

##9-SSR fingerprintset in 629 samples##
#Importing data
Mydat = read.table("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/Raw_allele_data_grouped_pub.txt", header = TRUE, stringsAsFactors = FALSE)
...
ggsave(file="/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Hops_04.01.2021_version/Figure_4_04.01.2021.pdf", plot= g1, device = "pdf", dpi = 300)
...
ggsave(file="/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Hops_04.01.2021_version/S1_figure_04.01.2021.pdf", plot= t4, device = "pdf", dpi = 300)
...
pdf("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Hops_04.01.2021_version/Figure_5_04.01.2021.pdf", width = 11, height = 5) 
...
nulls(inputFile = "/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/Raw_allele_data_grouped_pub.gen",
  outputFile = "",
  settingsFile = "",
  nullAlleleMethod = "",
  CIcoverage = 0.95,
...
mydatSSR = read.table("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/9SSR_190samples_withdiscrepancies.txt", header = TRUE, stringsAsFactors = FALSE)
mydatSNP = read.table("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/25_KASP_SNP.txt", header = TRUE, stringsAsFactors = FALSE)
...
ggsave(file="/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Results/Fig1.eps", plot= SSR_KASP_compare, device = cairo_ps)

#Importing 9-SSR and 25 KASP allele data - only unique genotypes
mydatSSR_grouped = read.table("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/9SSR_190samples_grouped.txt", header = TRUE, stringsAsFactors = FALSE)
mydatSNP_grouped = read.table("/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Data_availability/25_KASP_SNP_grouped.txt", header = TRUE, stringsAsFactors = FALSE)
...
writeLines(capture.output(sessionInfo()), "/Users/mandiedriskill/Desktop/USDA/Hops/Final_scientific_documents/Hops_08.19.2021/source_code_documents/session_info.txt")
